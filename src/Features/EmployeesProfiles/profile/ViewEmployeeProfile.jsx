      ...
      <div className="container">
        <div className="info-container">
          ...
          <Form form={form} layout="horizontal">
            <GeneralInfo show={segmentValue === 1} editMode form={form} />
            <DrivingLicense
              show={segmentValue === 2}
              editMode
              form={form}
            ...
            />
            <Employment show={segmentValue === 3} editMode form={form} />
            <Skills show={segmentValue === 4} editMode form={form} />
            <Education show={segmentValue === 5} editMode form={form} />
            <Certificates show={segmentValue === 6} editMode form={form} />
            <Additional show={segmentValue === 7} editMode form={form} />
          </Form>
        </div>
