...
import ViewEditAccountDrawer from "./components/drawers/ViewEditAccountDrawer";
import EditDepartmentDrawer from "./components/drawers/EditDepartmentDrawer";
      ...
      >
        ...
        >
          <div style={{ display: "inline-block" }}>
            <Tag color="#1d39c4" style={{ fontSize: "1rem" , marginBottom:"2rem" } }>
              {"department name"}
            </Tag>
          </div>
          <Image
