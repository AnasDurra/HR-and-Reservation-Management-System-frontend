...
const ViewJobApplication = () => {
    ...
    return (
        <Spinner loading={jobApplicationsSlice.loading}>
                ...
                >
                    {!isEditMode && (
                        <>
                            ...
                            >
                                <h5 style={{ marginTop: 0, padding: 0 }}>
                                    حالة الطلب:{' '}
                                </h5>
                                <Tag
                            ...
                            <VacancyCard
                                vacancyName={
                                    jobApplication?.job_application?.job_vacancy
                                        ?.name
                                }
                                vacancyDescription={
                                    jobApplication?.job_application?.job_vacancy
                ...
                <Spinner loading={jobVacanciesSlice.loading}>
                    ...
                    >
                        <Select
                            ...
                            options={jobVacanciesSlice.jobVacancies.map(
                                (jv) => ({
                                    value: jv.id,
                                    label: jv.name,
                                })
            ...
            <CreateProfileDrawer
                employeeName={
                    jobApplication?.employee_data?.personal_data?.full_name
                }
